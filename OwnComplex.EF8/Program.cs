...
var host = Host.CreateDefaultBuilder(args)
    ...
    .ConfigureServices(services =>
    {
        ...
        services.AddDbContext<TestEF8Context>(ServiceLifetime.Scoped, ServiceLifetime.Scoped);
        services.AddScoped<IPeopleRepository>(provider => provider.GetRequiredService<TestEF8Context>());
